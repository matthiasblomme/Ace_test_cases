...
public class FeedApplication_com_mbl_test_processFeed_Compute_0001_Test {

	/*
	 * FeedApplication_com_mbl_test_processFeed_Compute_0001_Test
	 * Test generated by IBM App Connect Enterprise Toolkit 12.0.12.4 on 1 Aug 2024, 14:08:21
	 */
	...
	@Test
	public void FeedApplication_com_mbl_test_processFeed_Compute_TestCase_001() throws TestException {

		// Define the SpyObjectReference
		SpyObjectReference nodeReference = new SpyObjectReference().application("FeedApplication")
				.messageFlow("com.mbl.test.processFeed").node("Compute");
		...
		try {
			String messageAssemblyPath = "/processFeed_Compute_0001_a497a30c-1002-4cfe-8276-d153f3775bb7_input_data.mxml";
		...
		try {
			...
			String messageAssemblyPath = "/processFeed_Compute_0001_0d31992a-d509-4ac5-ad68-e455243a8259_output_data.mxml";
			InputStream messageStream = Thread.currentThread().getContextClassLoader()
					.getResourceAsStream(messageAssemblyPath);
			if (messageStream == null) {
				throw new TestException("Unable to locate message assembly file: " + messageAssemblyPath);
